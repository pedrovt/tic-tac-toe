...
public final class TicTacToe extends JFrame {
	...
	private void createMenu() {
		...
		newGameButton.addActionListener(new ActionListener() {  // Dialog box when pressed 
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				int option = JOptionPane.showConfirmDialog(getContentPane(), "Do you want to start a new game?", newGameButton.getLabel(), JOptionPane.YES_NO_OPTION);  
		...
		closeButton.addActionListener(new ActionListener() {	// Dialog box when pressed
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				int option = JOptionPane.showConfirmDialog(getContentPane(), "Do you want to close the game?", closeButton.getLabel(), JOptionPane.YES_NO_OPTION);  
				if (option == 0) {
		...
		helpButton.addActionListener(new ActionListener() {		// Dialog box when pressed
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(getContentPane(), ("Simple version of Tic Tac Toe\nVersion v" + version + "\nNovember 2017"), helpButton.getLabel(), 1, new ImageIcon(TicTacToe.class.getResource("resources/tic-tac-toe-icons-small.png"))); 
			}
		});
	...
	/**
	 * Start/Restart Game with custom value for first user and default value for imension
	 * @param argFirstUser
	 */
	...
	private int searchWin (User user, int currentScore, int line, int col, int incrementLine, int incrementCol) {
		...
		// 3. Outside the limits of the board
